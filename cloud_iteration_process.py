...
folder = os.path.join(greb.cloud_folder(),f'cld.artificial.iteration{ocean_flag}_{corr}corr')
...
new_name = os.path.join(folder,f'cld.artificial.iter{niter}{ocean_flag}_{corr}corr')
