...
if time == 'monthly':
    ...
    dT = correct(t_new-t_old) if corr else t_new-t_old
    r_cld = dCLD/dT
...
if time == 'annual':
    ...
    dT = correct(t_new_am-t_old_am) if corr else t_new_am-t_old_am
    r_cld = dCLD/dT
    dCLD_new = -r_cld*(t_new_am-t_c_am)
    new_cloud = dCLD_new+cld_new
# #========================================================================== #

new_name = '/Users/dmar0022/university/phd/greb-official/artificial_clouds/cld.artificial.iter{}_{}{}'.format(niter,time,corr_)
